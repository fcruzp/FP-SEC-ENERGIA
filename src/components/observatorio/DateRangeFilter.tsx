    ...
    <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
      {ranges.map(({ key, label }) => (
        <Button
          ...
          className={
            active === key
              ? 'bg-[#1a6b3c] dark:bg-[#155d35] hover:bg-[#2d9e5f] dark:hover:bg-[#1a6b3c] text-white text-xs h-8 cursor-pointer'
              : 'border-[#e5e7eb] dark:border-[#30363d] text-[#6b7280] dark:text-[#8b949e] hover:text-[#1a6b3c] dark:hover:text-[#4ade80] hover:border-[#1a6b3c] dark:hover:border-[#4ade80] text-xs h-8 cursor-pointer'
          }
        >
          {label}
        </Button>
